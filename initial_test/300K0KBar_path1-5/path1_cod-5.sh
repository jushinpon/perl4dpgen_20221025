#!/bin/sh
#sed_anchor01
#SBATCH --output=path1_cod-5.sout
#SBATCH --job-name=300K0KBar-path1_cod-5
#SBATCH --nodes=1
#SBATCH --partition=C16M32_i712G
...
#sed_anchor02
mpiexec /opt/QEGCC_MPICH3.4.2/bin/pw.x -in path1_cod-5.in
