#!/bin/sh
#sed_anchor01
#SBATCH --output=NaFePO4_olivine-00.sout
#SBATCH --job-name=NaFePO4_olivine-00
#SBATCH --nodes=2
#SBATCH --partition=C16_Parallel
...
#sed_anchor02
mpiexec /opt/QEGCC_MPICH3.4.2/bin/pw.x -in NaFePO4_olivine-00.in
