#!/bin/sh
#sed_anchor01
#SBATCH --output=scale_3d-04.sout
#SBATCH --job-name=scale_3d-04
#SBATCH --nodes=2
#SBATCH --partition=C24_Parallel 
##SBATCH --exclude=node04,node11,node08,node09,node12
...
#sed_anchor02
mpiexec /opt/QEGCC_MPICH3.4.2/bin/pw.x -in scale_3d-04.in
